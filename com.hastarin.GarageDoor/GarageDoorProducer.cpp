...
void GarageDoorProducer::CallOpenHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
...
void GarageDoorProducer::CallCloseHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    auto source = SourceObjects.find(busObject);
    if (source == SourceObjects.end())
    {
    ...
    if (producer->Service != nullptr)
    {
        ...
        GarageDoorCloseResult^ result = create_task(producer->Service->CloseAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void GarageDoorProducer::CallPushButtonHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    auto source = SourceObjects.find(busObject);
    if (source == SourceObjects.end())
    {
    ...
    if (producer->Service != nullptr)
    {
        ...
        GarageDoorPushButtonResult^ result = create_task(producer->Service->PushButtonAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
QStatus GarageDoorProducer::OnPropertyGet(_In_ PCSTR interfaceName, _In_ PCSTR propertyName, _Inout_ alljoyn_msgarg value)
{
    ...
    if (0 == strcmp(propertyName, "IsOpen"))
    {
        auto task = create_task(Service->GetIsOpenAsync(nullptr));
        ...
        return create_task([](){}).then([=]() -> QStatus
        {
            ...
            return static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(value, "b", result->IsOpen));
        }, result->m_creationContext).get();
    }
    if (0 == strcmp(propertyName, "IsPartiallyOpen"))
    {
        auto task = create_task(Service->GetIsPartiallyOpenAsync(nullptr));
        auto result = task.get();
        ...
        return create_task([](){}).then([=]() -> QStatus
        {
            ...
            return static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(value, "b", result->IsPartiallyOpen));
        }, result->m_creationContext).get();
    }
...
void GarageDoorProducer::EmitIsOpenChanged()
{
    create_task([&]
    {
        alljoyn_msgarg value = alljoyn_msgarg_create();
        OnPropertyGet("com.hastarin.GarageDoor", "IsOpen", value);
...
void GarageDoorProducer::EmitIsPartiallyOpenChanged()
{
    create_task([&]
    {
        alljoyn_msgarg value = alljoyn_msgarg_create();
        OnPropertyGet("com.hastarin.GarageDoor", "IsPartiallyOpen", value);
...
void GarageDoorProducer::Start()
{
    ...
    alljoyn_interfacedescription interfaceDescription = alljoyn_busattachment_getinterface(AllJoynHelpers::GetInternalBusAttachment(m_busAttachment), "com.hastarin.GarageDoor");
    ...
    result = AddMethodHandler(
        ...
        "Open", 
        [](alljoyn_busobject busObject, const alljoyn_interfacedescription_member* member, alljoyn_message message) { UNREFERENCED_PARAMETER(member); CallOpenHandler(busObject, message); });
    if (result != ER_OK)
    {
        StopInternal(result);
        return;
    ...
    result = AddMethodHandler(
        interfaceDescription, 
        "Close", 
        [](alljoyn_busobject busObject, const alljoyn_interfacedescription_member* member, alljoyn_message message) { UNREFERENCED_PARAMETER(member); CallCloseHandler(busObject, message); });
    if (result != ER_OK)
    {
        StopInternal(result);
        return;
    ...
    result = AddMethodHandler(
        interfaceDescription, 
        "PushButton", 
        [](alljoyn_busobject busObject, const alljoyn_interfacedescription_member* member, alljoyn_message message) { UNREFERENCED_PARAMETER(member); CallPushButtonHandler(busObject, message); });
    if (result != ER_OK)
    {
        StopInternal(result);
        return;
...
PCSTR com::hastarin::GarageDoor::c_GarageDoorIntrospectionXml = "<interface name=\"com.hastarin.GarageDoor\">"
